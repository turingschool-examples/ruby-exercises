...
class HashesTest < Minitest::Test
  ...
  def test_5
    # In the line below, define the ingredients variable as a hash w/ the
    # first key of "tomatoes" with a value of 0 and the second key of
    # :carrots with a value of 0
    ingredients = ______
